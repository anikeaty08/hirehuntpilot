...
from hirehuntpilot.config import COVER_LETTER_DIR, RESUME_PATH, load_profile
...
def generate_cover_letter(
    ...
    letter = ""
    client = get_role_client("cover_letter")
...
def run_cover_letters(min_score: int = 7, limit: int = 20,
    ...
    for job in jobs:
        ...
        try:
            ...
            pdf_path = None
            try:
                from hirehuntpilot.scoring.pdf import convert_to_pdf
