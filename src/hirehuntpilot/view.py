"""hirehuntpilot HTML Dashboard Generator.
...
from hirehuntpilot.config import APP_DIR, DB_PATH
...
def generate_dashboard(output_path: str | None = None) -> str:
    ...
    Args:
        output_path: Where to write the HTML file. Defaults to ~/.hirehuntpilot/dashboard.html.
...
<title>hirehuntpilot Dashboard</title>
<style>
